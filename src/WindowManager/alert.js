...
export const alert = (options = {}) => {
	...
	if (icon) {
		...
		let svg
		if (type === "success") {
			closeButton.setAttribute("type", type)
			svg =
			...
			closeButton.setAttribute("type", "warning")
			svg =
