...
const createComponent = props => {
	...
	<div style="display:flex;flex-direction:column;gap:0.5rem;">
		...
		<button class="type-primary fill-light">Type Primary Fill Light</button>
		<button class="type-primary fill-outline">Type Primary Fill Outline</button>
		...
		<button class="type-secondary fill-outline">Type Secondary Fill Outline</button>
		...
		<button class="type-neutral fill-outline">Type Neutral Fill Outline</button>
		<button class="type-neutral fill-none">Type Neutral Fill None</button>
		<button class="type-info">Type Info</button>
		<button class="type-info fill-light">Type Info Fill Light</button>
		<button class="type-info fill-outline">Type Info Fill Outline</button>
		...
		<button class="type-success fill-outline">Type Success Fill Outline</button>
		...
		<button class="type-warning fill-outline">Type Warning Fill Outline</button>
		...
		<button class="type-error fill-outline">Type Error Fill Outline</button>
